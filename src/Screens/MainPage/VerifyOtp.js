...
const VerifyOtp = ({ navigation, route }) => {
    ...
    const handleVerificationCode = () => {
      if (verificationCode != userVerificationCode) {
        ...
        setLoading(true)
        fetch('http://coaching.futurevalue.in/api/ckeckotp', {
            method: 'post',
            headers: {
            ...
            //    else if (data.ResponseMsg === "login failed ") {
            //         setLoading(false)
        ...
        <View>
            <View style={[styles.container]}>
                ...
                <View style={{ marginTop: -20, marginBottom: 0, marginLeft: 10 }}>
                    <Text style={{ fontSize: 24, fontWeight: 'bold', color: '#111',alignSelf:'center' }}>Verify Phone</Text>
                    <Text style={{ fontSize: 16, fontWeight: 'bold', color: '#111',alignSelf:'center',marginTop: 20 }}>Phone : {usernumber}</Text>
                </View>
